"""
Django settings for TicklerProject project.
...
SECRET_KEY = 'django-insecure-lg68frlys&ojdt4ubiq7s6unincw2vo+m=rys()*!#q5+75-^3'
...
ROOT_URLCONF = 'TicklerProject.urls'
